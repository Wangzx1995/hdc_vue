...
var vertexYUVShader = [
    ...
    'void main()',
    '{',
    'gl_Position.x = vertexPos.x * u_CosB - vertexPos.y * u_SinB;',
    'gl_Position.y = vertexPos.x * u_SinB + vertexPos.y * u_CosB;',
...
(function (root, factory) {
    ...
    RenderManager.prototype.setDrawAngle = function (angle) {
        var gl = this.contextGL;

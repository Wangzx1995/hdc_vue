...
export default {
    ...
    watch: {
        ...
        selectDayRange: {
            handler: function (newVal) {
                this.currentYear = Number(newVal.minDate.split("-")[0]);
                this.currentMonth = Number(newVal.minDate.split("-")[1]);
            },
        },
    },
    methods: {
        ...
        getOnlineDate() {
            ...
            //     return;
            // }
            let params = { deviceCode: this.currentCar.deviceCode };
            let api = "getOnlineDateByDeviceCode";
            this.hasContent = [];

                ...
                <div ref="editTreeBtn" v-if="showEditTreeBtn">
                    ...
                    >
                        ...
                        <el-button
                            ...
                            slot="reference"
                            icon="el-icon-plus"
                            :disabled="!organizeId || currentNode.source != 1"
                        />
                    </el-popover>
                    <el-popover
                        placement="bottom"
...
export default {
    ...
    methods: {
        ...
        handleNodeClick(data) {
            ...
            this.$emit("update:value", this.organizeId);
        },
        ...
        editOrganize() {
            ...
            this.moveOrgList.id = this.organizeId;
                ...
                this.$api.deviceGetOrgTree().then((res) => {
                    if (res.success == true) {
                        ...
                        if (res.data.length > 0) {
                            this.organizeId = this.$store.state.tree
                                .deviceManageId

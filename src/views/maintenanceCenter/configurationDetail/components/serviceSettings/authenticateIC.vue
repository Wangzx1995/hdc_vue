    ...
    <div class="p-a-md">
        ...
        >
          <div class="configurations">
            ...
            <div v-if="form['001C'] " class="configuration-item">
            ...
            <div v-if="form['001D']" class="configuration-item">
